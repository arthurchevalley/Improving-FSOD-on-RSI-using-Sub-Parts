...
lr_config = dict(policy='step',warmup_iters=200, gamma=0.5, step=[5000, 10000, 20000])
runner = dict(max_iters=30000)
custom_hooks = [
    dict(type='ContrastiveLossDecayHook', decay_steps=(20000,25000), decay_rate=0.5)
]
log_config = dict(
    interval=50,
    hooks=[
...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split3_BranchPT_lrlow/epoch_12.pth --method random_init --tar-name base_contrastive_model_onlyFT --save-dir work_dirs/tfa_rsp_faster_rcnn_dior-base-split3_BranchPT_lrlow --no_contrastive_head --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/tfa_rsp_faster_rcnn_dior-base-split3_BranchPT_lrlow/base_contrastive_model_onlyFT_random_init_bbox_head.pth')