...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cosine=dict(iou_threshold=0.5, loss_weight=0.5),
            loss_c_cls=dict(iou_threshold=0.5, loss_weight=0.5),
            loss_base_aug=dict(iou_threshold=0.5, loss_weight=0.5),
