...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_c_bbox=None,
            to_norm_cls = True,
            queue_path = 'queue_dict/Queue_perclass_from_contrastive_base_perclass_changingw_withbg_FT_nobg.p', #None,#'per_class_features.p',#res.p',
            use_queue = True,
            use_base_queue = True,
...
load_from = ('work_dirs/contrastive_base_perclass_changingw_withbg_model_split2_random_init_bbox_head.pth')