...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_c_bbox=None,
            to_norm_cls = True,
            queue_path = None,#'queue_dict/Queue_perclass_from_contrastive_base_perclass_changingw_withbg_FT_nobg.p', #None,#'per_class_features.p',#res.p',
            use_queue = True,
            use_base_queue = True,
...
# base model needs to be initialized with following script: 
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_perclass_notlight_changingw_with_bginqueue_both/latest.pth --method random_init --tar-name contrastive_base_perclass_changingw_withbg_model_split2 --save-dir work_dirs --dior
# please refer to configs/detection/tfa/README.md for more details.

# python tools/misc/initialize_pretrain.py --src1 work_dirs/contrastive_base_perclass_changingw_withbg_model_split2_random_init_bbox_head.pth --base_withbg --queue class --nobg_save
load_from = ('work_dirs/contrastive_base_perclass_changingw_withbg_lowerw_model_split2_random_init_bbox_head.pth')
