...
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split3_CONTRASTIVE/latest.pth --method random_init --tar-name base_model_contrastive --save-dir work_dirs/tfa_rsp_faster_rcnn_dior-base-split3_CONTRASTIVE --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/tfa_rsp_faster_rcnn_dior-base-split3_CONTRASTIVE/base_model_contrastive_random_init_bbox_head.pth')
