...
custom_hooks = [dict(type='NumClassCheckHook'),
                ...
                increase_step_cls = .2,
                increase_step_bbox = .1, # 0.05 
                number_of_epoch_step_bbox = 7, # 2
                number_of_epoch_step_cls = 7) # 
                ]
# first ch. = 2 et nbr = 2
...
load_from = ('work_dirs/tfa_rsp_faster_rcnn_dior-base-split3/base_RSP_split3.pth')
