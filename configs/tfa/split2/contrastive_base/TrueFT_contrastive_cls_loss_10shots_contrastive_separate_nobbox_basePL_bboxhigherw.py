...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            num_classes=20,
            loss_bbox=dict(type='SmoothL1Loss_analyse', beta=1.0, loss_weight=1.5),
            loss_cosine=dict(
                type='QueueDualSupervisedContrastiveLoss_light_class',
                temperature=0.2,
                iou_threshold=0.5,
                loss_weight=0.5,
                reweight_type='none',
...
load_from = ('work_dirs/FINAL_WEIGHTS/truecls_contrastive_queue_model_split2_random_init_bbox_head.pth')