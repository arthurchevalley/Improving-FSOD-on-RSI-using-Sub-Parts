...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_changing_w_nobg/latest.pth --method random_init --tar-name base_model_10_7_5_withbg_split2 --save-dir work_dirs --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/FINAL_WEIGHTS/base_model_10_7_5_withbg_split2_random_init_bbox_head.pth')