...
# base model needs to be initialized with following script:
# python -m tools.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bboxw10/latest.pth --method random_init --tar-name contrastive_highw_base_model_split2 --save-dir work_dirs --dior
