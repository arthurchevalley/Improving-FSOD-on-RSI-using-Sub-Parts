...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_c_bbox=None,
            to_norm_cls = True,
            queue_path = 'V2_per_class_features_from_tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_agnostic_perclas_stack_rnd_select_6.p',#'per_class_features_from_contrastive_agnostic_perclass_withbginqueue.p',
            use_queue = True,
            use_base_queue = True,
