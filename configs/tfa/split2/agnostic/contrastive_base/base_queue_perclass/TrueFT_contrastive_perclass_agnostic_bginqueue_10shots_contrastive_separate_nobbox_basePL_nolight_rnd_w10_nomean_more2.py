...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_cosine=dict(
                type='QueueDualSupervisedContrastiveLoss_light_nobg',
                temperature=0.2,
                iou_threshold=0.5,
                loss_weight=0.5,
                reweight_type='none',
...
load_from = ('work_dirs/FINAL_WEIGHTS/contrastive_agnostic_perclass_withbginqueue_model_split2_random_init_bbox_head.pth')
