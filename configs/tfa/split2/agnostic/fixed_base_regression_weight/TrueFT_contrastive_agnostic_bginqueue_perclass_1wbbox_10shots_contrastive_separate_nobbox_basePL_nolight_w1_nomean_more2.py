...
# base model needs to be initialized with following script:
# python -m tools.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_agnostic_perclass_fixw_withbg/latest.pth --method random_init --tar-name contrastive_agnostic_bginqueue_1wwbox_perclass_model_split2 --save-dir work_dirs --dior
