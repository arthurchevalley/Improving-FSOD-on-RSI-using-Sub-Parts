...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            num_classes=20,
            loss_bbox=dict(type='SmoothL1Loss_analyse', beta=1.0, loss_weight=20.0),
            loss_cosine=dict(
...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_agnostic_samew_high/latest.pth --method random_init --tar-name contrastive_agnostic_samew_high_model_split2 --save-dir work_dirs --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/contrastive_agnostic_samew_high_model_split2_random_init_bbox_head.pth')