    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_base_aug=dict(
                ...
                reweight_type='none',
                no_bg = True),
            loss_c_bbox=dict(type='UPAllIoULossBBOX', loss_weight=.5),
            to_norm_cls = True,
            queue_path = 'per_class_features_from_contrastive_agnostic_perclass_withbginqueue.p',#'V2_per_class_features_from_tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_agnostic_perclas_stack_rnd_select_6.p',
            use_queue = True,
            use_base_queue = True,
...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_agnostic_perclass_withbg_inqueue_longerqueue/latest.pth --method random_init --tar-name contrastive_agnostic_perclass_withbginqueue_model_split2 --save-dir work_dirs --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/contrastive_agnostic_perclass_withbginqueue_model_split2_random_init_bbox_head.pth')
