...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_c_bbox=None,
            to_norm_cls = True,
            queue_path = 'V2_per_class_features_from_tfa_rsp_faster_rcnn_dior_DenseFPN-base-split2-contrastive_trueclasses_b_stacked_6.p',#'per_class_features.p',#res.p',
            use_queue = True,
            use_base_queue = True,
...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior_DenseFPN-base-split2-contrastive_trueclasses_bbox_agnostic_perclass_withbg/latest.pth --method random_init --tar-name DenseFPN_contrastive_perclass_agnostic_model_split2 --save-dir work_dirs --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/DenseFPN_contrastive_perclass_agnostic_model_split2_random_init_bbox_head.pth')