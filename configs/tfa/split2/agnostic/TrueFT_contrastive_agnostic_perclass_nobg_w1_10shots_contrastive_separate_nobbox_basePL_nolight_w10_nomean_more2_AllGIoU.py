...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2-contrastive_trueclasses_bbox_agnostic_perclass_fixw/latest.pth --method random_init --tar-name contrastive_agnostic_perclass_nobg_w1_model_split2 --save-dir work_dirs --dior
