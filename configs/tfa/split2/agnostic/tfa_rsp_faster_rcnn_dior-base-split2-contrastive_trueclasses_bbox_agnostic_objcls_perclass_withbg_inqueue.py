...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls = dict(type='Object_CrossEntropyLoss', nbr_classes=15,use_sigmoid=False, loss_weight=1.0),
            loss_cosine=dict(
            ...
            loss_c_bbox=None,
            to_norm_cls = True,
            queue_path = 'base_features_10_7_4.9_perclass.p',
            use_queue = True,
            use_base_queue = True,
