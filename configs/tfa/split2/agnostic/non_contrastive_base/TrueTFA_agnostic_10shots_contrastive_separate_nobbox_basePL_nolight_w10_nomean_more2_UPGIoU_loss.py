    ...
    roi_head=dict(
        bbox_head=dict(
            ...
            loss_base_aug=dict(
                ...
                reweight_type='none',
                no_bg = True),
            loss_c_bbox=dict(type='UPIoULossBBOX', loss_weight=0.5),
            to_norm_cls = True,
            queue_path = None,
            use_queue = True,
            use_base_queue = True,
...
# base model needs to be initialized with following script:
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base-split2_agnostic/latest.pth --method random_init --tar-name agnostic_model_split2 --save-dir work_dirs --dior
# please refer to configs/detection/tfa/README.md for more details.


load_from = ('work_dirs/FINAL_WEIGHTS/agnostic_model_split2_random_init_bbox_head.pth')