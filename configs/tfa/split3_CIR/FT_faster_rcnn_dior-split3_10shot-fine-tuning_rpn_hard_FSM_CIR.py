_base_ = [
    ...
    '../tfa_r50_unfreeze_FSM_CIR_fpn.py',
...
# python -m tools.misc.initialize_bbox_head --src1 work_dirs/tfa_rsp_faster_rcnn_dior-base_split3_FSM_CIR/latest.pth --method random_init --tar-name base_model_CIR --save-dir work_dirs/tfa_rsp_faster_rcnn_dior-base_split3_FSM_CIR --dior
