...
class CIR(BaseModule):
    ...
    def __init__(self,
        ...
        super(CIR, self).__init__(init_cfg)
        ...
        for i in range(self.start_level, self.backbone_end_level):
            if i != self.backbone_end_level - 1:
                ...
                dilatation_size = [3,6,12,18,24]
                l_conv = self.cir_conv(self.in_channels[i], self.out_channels, 3, 1, 1, dilatation_size)
...
class DenseCIR(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=dict(
                     type='Xavier', layer='Conv2d', distribution='uniform')):
        super(DenseCIR, self).__init__(init_cfg)
        assert isinstance(in_channels, list)
        self.in_channels = in_channels
        self.out_channels = out_channels
        self.num_ins = len(in_channels)
