...
DIOR_FSANN_test = '/home/archeval/mmdetection/CATNet/mmdetection/data/dior2/few_shot_ann2/'
...
def parse_args():
    ...
    parser.add_argument('--save_dir', default=DIOR_FSANN_test, help='directory of the image to analyse')
    ...
    if args.few_shot_ann != 'none':
        ...
        for shot in nbr_shots:
            ...
            for curent_class_name in df_inst_file['category'].unique():
                ...
                save_path = args.save_dir+args.few_shot_ann+'_benchmark_'+str(shot)+'shot'
...
def create_tiles_few_shot_ann_dior(directory=None, version_ann='v3', nbr_shots=None,big=False, save=True):
    import os.path
...
if __name__ == '__main__':
  ...
  #  check_stuff_faster()
    ...
    create_tiles_few_shot_ann_dior()
